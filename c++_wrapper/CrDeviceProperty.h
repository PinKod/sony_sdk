...
class CrLevelInfo {
  public:
    CrLevelInfo()
        : state(CrLevel_Off), reserved(0), x(0), y(0), z(0) {}
    ~CrLevelInfo() {}
...
class CrFocusFrameInfo {
  public:
    CrFocusFrameInfo()
        : type(CrFocusFrameType_Unknown), state(CrFocusFrameState_Unknown), priority(0), xNumerator(0), xDenominator(0), yNumerator(0), yDenominator(0), width(0), height(0) {}
    ~CrFocusFrameInfo() {}
...
class CrFaceFrameInfo {
  public:
    CrFaceFrameInfo()
        : type(CrFaceFrameType_Unknown), state(CrFocusFrameState_Unknown), isSelected(CrFocusFrameSelectState_Unknown), priority(0), xNumerator(0), xDenominator(0), yNumerator(0), yDenominator(0), width(0), height(0) {}
    ~CrFaceFrameInfo() {}
...
class CrTrackingFrameInfo {
  public:
    CrTrackingFrameInfo()
        : type(CrTrackingFrameType_Unknown), state(CrFocusFrameState_Unknown), priority(0), xNumerator(0), xDenominator(0), yNumerator(0), yDenominator(0), width(0), height(0) {}
    ~CrTrackingFrameInfo() {}
...
class CrMagPosInfo {
  public:
    CrMagPosInfo()
        : xNumerator(0), xDenominator(0), yNumerator(0), yDenominator(0), width(0), height(0) {}
    ~CrMagPosInfo() {}
