...
namespace SCRSDK
{
	...
	enum
	{
		...
		CrError_Genric_Unknown						= CrError_Generic,  //0x8000  ///target
		CrError_Genric_Notimpl,                                         //0x8001   
		CrError_Genric_Abort,                                           //0x8002 
		CrError_Genric_NotSupported,                                    //0x8003        
		CrError_Genric_SeriousErrorNotSupported,                        //0x8004    
		CrError_Genric_InvalidHandle,                                   //0x8005         
		CrError_Genric_InvalidParameter,                                //0x8006            
