...
#define NFO_FOCUS_POSITION_SETTING_FILE "focus_position_setting.nfo"
#define LIST_FOCUS_POSITION_SETTING_FILE "focus_position_setting.list"
...
//
// live veiw quality codes
#define FOCUS_POSITION_SETTING_CODE        526U
#define FOCUS_POSITION_SETTING_VALUE_TYPE  16386U
#define FOCUS_POSITION_SETTING_TABLE_COUNT 2
typedef unsigned short FOCUS_POSITION_SETTING_TYPE;
FOCUS_POSITION_SETTING_TYPE FOCUS_POSITION_SETTING_TABLE_API_CODES[FOCUS_POSITION_SETTING_TABLE_COUNT] = {
    0,
    65535};
char* FOCUS_POSITION_SETTING_TABLE_API_LIST[FOCUS_POSITION_SETTING_TABLE_COUNT] = {
    "min"
    "max"};
//
//
